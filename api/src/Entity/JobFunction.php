 ...
 * )
 *
 * @ORM\Entity(repositoryClass="App\Repository\JobFunctionRepository")
...
class JobFunction
{
    ...
    /**
     * @var string Name of the Job Function
     *
     * @example Job Function name
     * @Groups({"read", "write"})
    ...
    /**
     * @var string Description of the Job Function
     *
